...
SIGNAL \GPIO_0[0]~18\ : std_logic;
SIGNAL \GPIO_0[1]~19\ : std_logic;
SIGNAL \GPIO_0[2]~20\ : std_logic;
...
SIGNAL \semaforo|count[3]~2_combout\ : std_logic;
SIGNAL \semaforo|count~3_combout\ : std_logic;
SIGNAL \semaforo|count~0_combout\ : std_logic;
SIGNAL \semaforo|count~5_combout\ : std_logic;
SIGNAL \semaforo|state_reg[0]~1_combout\ : std_logic;
SIGNAL \semaforo|Decoder2~0_combout\ : std_logic;
SIGNAL \semaforo|Decoder2~1_combout\ : std_logic;
...
SIGNAL \semaforo|Mux0~0_combout\ : std_logic;
SIGNAL \semaforo|Decoder2~2_combout\ : std_logic;
SIGNAL \semaforo|Decoder2~3_combout\ : std_logic;
SIGNAL \semaforo|Mux1~0_combout\ : std_logic;
SIGNAL \clock_filter|clk_counter\ : std_logic_vector(25 DOWNTO 0);
SIGNAL \semaforo|state_reg\ : std_logic_vector(2 DOWNTO 0);
...
-- Equation(s):
-- \semaforo|Add0~1_combout\ = \semaforo|count\(2) $ (((\semaforo|count\(0) & \semaforo|count\(1))))
...
-- Equation(s):
-- \semaforo|state_reg[1]~0_combout\ = \semaforo|state_reg\(1) $ (((\semaforo|state_reg\(0) & !\semaforo|count~0_combout\)))
...
PORT MAP (
	...
	datad => \semaforo|count~0_combout\,
...
-- Equation(s):
-- \semaforo|count[3]~1_combout\ = (!\semaforo|state_reg\(0) & ((\semaforo|state_reg\(1) & (\GPIO_0[2]~20\)) # (!\semaforo|state_reg\(1) & ((\GPIO_0[1]~19\)))))
...
PORT MAP (
	...
	datac => \GPIO_0[1]~19\,
	datad => \semaforo|state_reg\(0),
	combout => \semaforo|count[3]~1_combout\);

-- Location: LCCOMB_X64_Y29_N14
\semaforo|count~4\ : cycloneii_lcell_comb
-- Equation(s):
-- \semaforo|count~4_combout\ = (!\semaforo|count\(0) & (\semaforo|count~0_combout\ & ((!\semaforo|count[3]~1_combout\) # (!\semaforo|count[3]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \semaforo|count[3]~2_combout\,
	datab => \semaforo|count[3]~1_combout\,
	datac => \semaforo|count\(0),
	datad => \semaforo|count~0_combout\,
...
\semaforo|count[3]~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \semaforo|count[3]~2_combout\ = (!\semaforo|count\(2) & ((!\semaforo|count\(1)) # (!\semaforo|count\(0))))
...
PORT MAP (
	...
	datac => \semaforo|count\(0),
	datad => \semaforo|count\(1),
	combout => \semaforo|count[3]~2_combout\);

-- Location: LCCOMB_X64_Y29_N12
\semaforo|count~3\ : cycloneii_lcell_comb
-- Equation(s):
-- \semaforo|count~3_combout\ = (\semaforo|Add0~0_combout\ & (\semaforo|count~0_combout\ & ((!\semaforo|count[3]~1_combout\) # (!\semaforo|count[3]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \semaforo|Add0~0_combout\,
	datab => \semaforo|count~0_combout\,
	datac => \semaforo|count[3]~2_combout\,
...
\semaforo|count~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \semaforo|count~0_combout\ = ((\semaforo|state_reg\(0) & (!\semaforo|count\(0) & !\semaforo|count\(1)))) # (!\semaforo|count\(2))
...
PORT MAP (
	...
	datac => \semaforo|count\(0),
	datad => \semaforo|count\(1),
	combout => \semaforo|count~0_combout\);

-- Location: LCCOMB_X64_Y29_N4
\semaforo|count~5\ : cycloneii_lcell_comb
-- Equation(s):
-- \semaforo|count~5_combout\ = (\semaforo|count~0_combout\ & ((\semaforo|Add0~1_combout\) # ((\semaforo|count[3]~2_combout\ & \semaforo|count[3]~1_combout\))))
...
-- Equation(s):
-- \semaforo|state_reg[0]~1_combout\ = (\semaforo|count\(2) & (((!\semaforo|count\(1) & !\semaforo|count\(0))) # (!\semaforo|state_reg\(0)))) # (!\semaforo|count\(2) & (((\semaforo|state_reg\(0)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \semaforo|count\(1),
	datab => \semaforo|count\(2),
	datac => \semaforo|state_reg\(0),
	datad => \semaforo|count\(0),
...
\semaforo|Decoder2~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \semaforo|Decoder2~0_combout\ = (!\semaforo|state_reg\(0) & !\semaforo|state_reg\(1))
...
PORT MAP (
	...
	combout => \semaforo|Decoder2~0_combout\);

-- Location: LCCOMB_X64_Y29_N30
\semaforo|Decoder2~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \semaforo|Decoder2~1_combout\ = (\semaforo|state_reg\(0) & !\semaforo|state_reg\(1))
...
PORT MAP (
	datab => \semaforo|state_reg\(0),
	datad => \semaforo|state_reg\(1),
	combout => \semaforo|Decoder2~1_combout\);

-- Location: LCCOMB_X64_Y20_N8
\clock_filter|clk_counter[1]~25\ : cycloneii_lcell_comb
-- Equation(s):
-- \clock_filter|clk_counter[1]~25_combout\ = (\clock_filter|clk_counter\(0) & (\clock_filter|clk_counter\(1) $ (VCC))) # (!\clock_filter|clk_counter\(0) & (\clock_filter|clk_counter\(1) & VCC))
-- \clock_filter|clk_counter[1]~26\ = CARRY((\clock_filter|clk_counter\(0) & \clock_filter|clk_counter\(1)))
...
-- pragma translate_on
PORT MAP (
	dataa => \clock_filter|clk_counter\(0),
	datab => \clock_filter|clk_counter\(1),
	datad => VCC,
...
\semaforo|Mux0~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \semaforo|Mux0~0_combout\ = (\semaforo|state_reg\(1) & ((\clock_filter|clk_counter\(25)) # (!\semaforo|state_reg\(0))))
...
PORT MAP (
	datab => \semaforo|state_reg\(0),
	datac => \semaforo|state_reg\(1),
	datad => \clock_filter|clk_counter\(25),
	combout => \semaforo|Mux0~0_combout\);

-- Location: LCCOMB_X64_Y29_N6
\semaforo|Decoder2~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \semaforo|Decoder2~2_combout\ = (!\semaforo|state_reg\(0) & \semaforo|state_reg\(1))
...
PORT MAP (
	datab => \semaforo|state_reg\(0),
	datad => \semaforo|state_reg\(1),
	combout => \semaforo|Decoder2~2_combout\);

-- Location: LCCOMB_X64_Y29_N0
\semaforo|Decoder2~3\ : cycloneii_lcell_comb
-- Equation(s):
-- \semaforo|Decoder2~3_combout\ = (\semaforo|state_reg\(0) & \semaforo|state_reg\(1))
...
PORT MAP (
	datab => \semaforo|state_reg\(0),
	datad => \semaforo|state_reg\(1),
	combout => \semaforo|Decoder2~3_combout\);

-- Location: LCCOMB_X64_Y29_N26
\semaforo|Mux1~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \semaforo|Mux1~0_combout\ = (!\semaforo|state_reg\(1) & ((\clock_filter|clk_counter\(25)) # (!\semaforo|state_reg\(0))))
...
PORT MAP (
	...
	datac => \semaforo|state_reg\(1),
	datad => \clock_filter|clk_counter\(25),
	combout => \semaforo|Mux1~0_combout\);
...
-- pragma translate_on
PORT MAP (
	datain => \semaforo|Decoder2~0_combout\,
	oe => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	datain => \semaforo|Decoder2~1_combout\,
	oe => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	datain => \semaforo|Mux0~0_combout\,
	oe => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	datain => \semaforo|Decoder2~2_combout\,
	oe => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	datain => \semaforo|Decoder2~3_combout\,
	oe => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	datain => \semaforo|Mux1~0_combout\,
	oe => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
